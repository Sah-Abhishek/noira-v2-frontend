...
const DateTimePicker = ({ availableTimes = [] }) => {
  ...
  useEffect(() => {
    if (date && time && postalCode && !loading) {
      handleConfirm();
    }
  }, [date, time, postalCode]);
  ...
  return (
    <div className=" bg-black  text-white font-sans px-4 sm:px-6 md:px-10 pt-2 sm:pt-3 md:pt-4 pb-4 sm:pb-6 md:pb-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-6 sm:mb-10">
          <div className="flex items-center flex-col">
            ...
            {/* Current postcode + Change action */}
            <div className="mt-4 inline-flex items-center gap-2 bg-[#111] border border-primary/30 rounded-full px-4 py-2 text-sm sm:text-base">
