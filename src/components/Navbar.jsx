    ...
    >
      ...
      <Link to="/" className="flex-shrink-0">
        <div className="flex items-center">
          <img src={noira} alt="Logo" className="h-8 sm:h-10 md:h-11 lg:h-12 w-auto" />
        </div>
      </Link>
      ...
      <button
        ...
        className="xl:hidden focus:outline-none z-50 relative flex-shrink-0 p-1"
        aria-label="Toggle menu"
      >
        {isOpen ? (
          <X className="text-[#95793e] w-6 h-6 sm:w-7 sm:h-7" />
        ) : (
          <Menu className="text-[#95793e] w-6 h-6 sm:w-7 sm:h-7" />
        )}
      </button>
